            ...
            <?php if ( have_rows( 'primary_footer_section', 'option' ) ) : ?>
                <?php while ( have_rows( 'primary_footer_section', 'option' ) ) : the_row(); ?>
                    ...
                    <div class="internal-links pull-right">
                                    <a target="_blank" href="https://astra.si/wp-content/uploads/astra-ai-splosni-pogoji.pdf">POLITIKA ZASEBNOSTI IN SPLOŠNI POGOJI</a>
                                    <a href="https://astra.si">NAZAJ NA ASTRA.SI</a>
                    </div>
